# Prompt #12: Formulario - Datos Económicos - BaldeCash Web 3.0
...
│       ├── components/
│       │   ├── IncomeSourceSelector.tsx
│       │   ├── EmploymentFields.tsx
│       │   ├── BusinessFields.tsx
│       │   ├── FamilyFields.tsx
│       │   ├── IncomeAmountInput.tsx
│       │   └── VerificationCheckbox.tsx
└── ECONOMIC_README.md
```
...
#### C4.1 [ITERAR - 3 versiones]
**¿Las opciones de fuente de ingreso deben ser cards grandes con iconos?**
- **V1**: Cards grandes con icono + descripción
- **V2**: Radio buttons tradicionales
- **V3**: Chips seleccionables

#### C4.2 [ITERAR - 3 versiones]
**¿Debe explicarse brevemente cada opción?**
- **V1**: Descripción visible siempre
- **V2**: Descripción en hover/tooltip
- **V3**: Sin descripción (solo label)
...
#### C4.11 [ITERAR - 3 versiones]
**¿La sección de datos del familiar debe tener diseño diferenciado?**
- **V1**: Card con borde diferente
- **V2**: Sección con título destacado
- **V3**: Mismo estilo que el resto
...
#### C4.14 [ITERAR - 3 versiones]
**¿El checkbox de verificación laboral debe estar al inicio o al final?**
- **V1**: Al final de la sección
- **V2**: Después de cada campo relevante
- **V3**: Como paso separado
...
## 4. Campos por Fuente de Ingreso
...
/**
 * IncomeSourceSelectorV1 - Cards Grandes
 */
          ...
          return (
            ...
            >
              <CardBody className="flex flex-row items-start gap-4 p-4">
                <div className={`p-3 rounded-lg ${isSelected ? 'bg-[#4247d2] text-white' : 'bg-neutral-100 text-neutral-600'}`}>
...
- [ ] `EconomicDataStep.tsx`
- [ ] `IncomeSourceSelectorV1.tsx`, `V2.tsx`, `V3.tsx`
- [ ] `EmploymentFields.tsx`
- [ ] `BusinessFields.tsx`
- [ ] `FamilyFields.tsx`
- [ ] `IncomeAmountInput.tsx` con formato moneda
- [ ] `VerificationCheckbox.tsx` con explicación
- [ ] Animaciones de campos condicionales
- [ ] `ECONOMIC_README.md`
