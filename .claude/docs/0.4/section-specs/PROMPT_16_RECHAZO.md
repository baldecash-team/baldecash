...
│       ├── visual/
│       │   └── RejectionVisualV[1-6].tsx
│       ├── illustration/
│       │   └── IllustrationTypeV[1-6].tsx
│       ├── branding/
│       │   └── BrandingLevelV[1-6].tsx
│       ├── message/
│       │   └── MessagePersonalizationV[1-6].tsx
│       ├── explanation/
│       │   ├── ExplanationDetailV[1-6].tsx
│       │   └── ExplanationFramingV[1-6].tsx
│       ├── alternatives/
│       │   ├── AlternativesLayoutV[1-6].tsx
│       │   ├── ProductAlternativesV[1-6].tsx
│       │   ├── DownPaymentCalculatorV[1-6].tsx
│       │   └── CosignerOption.tsx
│       ├── retention/
│       │   ├── EmailCaptureV[1-6].tsx
│       │   ├── RetryTimelineV[1-6].tsx
│       │   └── EducationalContent.tsx
│       └── support/
│           ├── AdvisorCTAV[1-6].tsx
│           ├── AdvisorMessageV[1-6].tsx
│           └── ContactOptions.tsx
├── types/
│   └── rejection.ts
└── REJECTION_README.md
...
- [ ] `types/rejection.ts` - RejectionConfig con 13 selectores (1-6)
- [ ] `RejectionSettingsModal.tsx` - Modal con 13 selectores

### Pantalla Principal
- [ ] `RejectionScreen.tsx`

### Visual (6 versiones cada uno)
- [ ] `RejectionVisualV1.tsx` a `V6.tsx`
- [ ] `IllustrationTypeV1.tsx` a `V6.tsx`
- [ ] `BrandingLevelV1.tsx` a `V6.tsx`

### Mensaje (6 versiones)
- [ ] `MessagePersonalizationV1.tsx` a `V6.tsx`

### Explicación (6 versiones cada uno)
- [ ] `ExplanationDetailV1.tsx` a `V6.tsx`
- [ ] `ExplanationFramingV1.tsx` a `V6.tsx`

### Alternativas (6 versiones cada uno)
- [ ] `AlternativesLayoutV1.tsx` a `V6.tsx`
- [ ] `ProductAlternativesV1.tsx` a `V6.tsx`
- [ ] `DownPaymentCalculatorV1.tsx` a `V6.tsx`
- [ ] `CosignerOption.tsx`

### Retención (6 versiones cada uno)
- [ ] `EmailCaptureV1.tsx` a `V6.tsx`
- [ ] `RetryTimelineV1.tsx` a `V6.tsx`
- [ ] `EducationalContent.tsx`

### Soporte (6 versiones cada uno)
- [ ] `AdvisorCTAV1.tsx` a `V6.tsx`
- [ ] `AdvisorMessageV1.tsx` a `V6.tsx`
- [ ] `ContactOptions.tsx`
