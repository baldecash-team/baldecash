# Prompt #3: Catálogo - Product Cards - BaldeCash Web 3.0
...
#### Pregunta B.37 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
...
**Versiones a generar:**
- **V1 - Técnico**: CPU, RAM, SSD, Pantalla con iconos (para usuarios que saben qué buscan)
- **V2 - Beneficios**: "Ideal para estudios", "Batería todo el día", "Liviana y portátil"
- **V3 - Híbrido**: 2 specs principales + 2 beneficios clave
...
#### Pregunta B.44 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
...
**Versiones a generar:**
- **V1**: 3 features como texto pequeño debajo de specs
- **V2**: 3 features como chips/tags coloridos
- **V3**: Features visibles solo en hover state
...
#### Pregunta B.47 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
| **Tema** | Cards - Target |
...
#### Pregunta B.48 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
| **Tema** | Cards - Badges |
...
#### Pregunta B.49 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
| **Tema** | Cards - Badges |
...
#### Pregunta B.59 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
| **Tema** | Cards - Stock |
...
**Versiones a generar:**
- **V1**: Badge prominente amarillo "¡Últimas 3 unidades!"
- **V2**: Texto sutil "Stock limitado" sin número
- **V3**: Indicador visual (barra de stock) sin texto
...
#### Pregunta B.61 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
| **Tema** | Cards - Interacción |
...
**Versiones a generar:**
- **V1**: Icono corazón en esquina superior (siempre visible)
- **V2**: Icono corazón visible solo en hover
- **V3**: Botón "Guardar" con texto al lado del CTA

#### Pregunta B.62 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
| **Tema** | Cards - Interacción |
...
**Versiones a generar:**
- **V1**: Hover muestra descripción + botón secundario
- **V2**: Hover muestra specs adicionales + key features
- **V3**: Card estática (sin cambios en hover, solo scale sutil)
...
#### Pregunta B.64 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
| **Tema** | Cards - Visual |
...
**Versiones a generar:**
- **V1**: Fondo blanco/neutral (estilo catálogo limpio)
- **V2**: Fondo con gradiente sutil de marca
- **V3**: Imagen en contexto (estudiante usando laptop)

#### Pregunta B.65 [ITERAR - 3 versiones]
| Campo | Valor |
|-------|-------|
| **Tema** | Cards - Visual |
...
**Versiones a generar:**
- **V1**: Una imagen principal, galería en hover
- **V2**: Dots indicadores, cambiar imagen en hover
- **V3**: Mini thumbnails debajo de imagen principal
...
export interface ProductCardConfig {
  cardVersion: 1 | 2 | 3;
  badgePosition: 'corner' | 'top' | 'ribbon';
  badgeColorScheme: 'semantic' | 'grayscale' | 'pastel';
  keyFeaturesDisplay: 'text' | 'chips' | 'hover';
  stockDisplay: 'prominent' | 'subtle' | 'bar';
  favoriteButton: 'always' | 'hover' | 'inline';
  hoverBehavior: 'description' | 'specs' | 'static';
  imageStyle: 'white' | 'gradient' | 'context';
  multipleImages: 'gallery-hover' | 'dots' | 'thumbnails';
}
```
...
| Ruta | Descripción |
|------|-------------|
| `/prototipos/0.2/catalogo/catalog-preview` | Preview con settings de cards |
| Dentro del settings modal | Selector de versión de card |

---

## 10. Checklist de Entregables

- [ ] `types/product.ts` - Tipos completos de producto
- [ ] `data/mockProducts.ts` - 6-12 productos de prueba variados
- [ ] `ProductCard.tsx` - Wrapper con versión configurable
- [ ] `ProductCardV1.tsx` - Enfoque técnico
- [ ] `ProductCardV2.tsx` - Enfoque beneficios
- [ ] `ProductCardV3.tsx` - Enfoque híbrido
- [ ] `CardImage.tsx` - Imagen con badges
- [ ] `CardBadges.tsx` - Sistema de badges (3 versiones posición, 3 colores)
...
- [ ] `CardHoverContent.tsx` - Contenido hover (3 versiones)
- [ ] `CardSkeleton.tsx` - Loading state
- [ ] Badges: Discount, Stock, New, Popular, Condition, Feature
- [ ] Interactions: FavoriteButton, CompareCheckbox
- [ ] `CARDS_README.md`
