...
export const HeroCta: React.FC<HeroCtaProps> = ({ data, onCtaClick, onQuizOpen, isCleanMode = false }) => {
  const router = useRouter();
  const catalogBasePath = data?.buttons.catalog.url || '/prototipos/0.5/catalogo/catalog-preview';
