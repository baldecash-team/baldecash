...
/**
 * SeguroDetalleSheet — bottom sheet de detalle de un SEGURO (feedback Emilio:
 * los seguros también tienen más info que mostrar).
 *
 * Mismo patrón visual que AccesorioDetalleSheet: header "← Volver a la lista"
 * + X, ícono de escudo, proveedor + nombre, descripción, coberturas (viñetas
 * verdes) y exclusiones si las hay, precio grande + plazo, botón "Agregar" /
 * "Quitar".
 *
...
export function SeguroDetalleSheet({ seguro, agregado, onAgregar, onVolver, onCerrar }: SeguroDetalleSheetProps) {
