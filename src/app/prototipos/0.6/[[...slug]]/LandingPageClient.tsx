...
function LandingPageClientInner({ slug, initialData, landingConfig = DEFAULT_LANDING_CONFIG }: LandingPageClientProps) {
  ...
  // On landing index load: if vip_auto param is present, save it as the VIP token and go
  // straight to catalog. Otherwise clear any stale VIP data so the user must re-validate.
  useEffect(() => {
