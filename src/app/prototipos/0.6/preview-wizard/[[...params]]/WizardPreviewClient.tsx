      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-neutral-800 mb-2">
            Preview del Wizard: {wizardConfig.landing?.name ?? wizardConfig.landing_name ?? ''}
          </h1>
          <p className="text-neutral-600">
            Landing: <code className="bg-neutral-100 px-2 py-1 rounded text-sm">{wizardConfig.landing?.slug ?? wizardConfig.landing_slug ?? ''}</code>
            {' '}&middot;{' '}
