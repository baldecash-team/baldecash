// Mock Data for Detail Section - BaldeCash v0.6
// Copied from v0.5 for product detail prototype
...
// Helper para crear imágenes de productos similares
const img = (url: string, variantId?: number): SimilarProductImage => ({ url, variantId });
...
export const mockSimilarProducts: SimilarProduct[] = [
  {
    ...
    displayName: 'Laptop HP 14" - Ryzen 7 7730U',
    brand: 'HP',
    thumbnail: 'https://cdn.prod.website-files.com/62141f21700a64ab3f816206/64ad8af9ed1fbf48ea397396_hp15.png',
    images: [
      img('https://cdn.prod.website-files.com/62141f21700a64ab3f816206/64ad8af9ed1fbf48ea397396_hp15.png'),
      img('https://cdn.prod.website-files.com/62141f21700a64ab3f816206/64ad7929bd7b580e6de7247d_Lenovo%20Chromebook%20S330.jpg'),
      img('https://cdn.prod.website-files.com/62141f21700a64ab3f816206/64ad78aca11478d9ed058463_laptop_asus_x515ea.jpg'),
    ],
    colors: [
  ...
  },
  {
    ...
    displayName: 'Laptop Lenovo 17.3" - Ryzen 5 7530U',
    brand: 'HP',
    thumbnail: 'https://cdn.prod.website-files.com/62141f21700a64ab3f816206/64ad8633afc74e8146b99e4a_VICTUS-15-FA0031DX-1.jpg',
    images: [
      img('https://cdn.prod.website-files.com/62141f21700a64ab3f816206/64ad8633afc74e8146b99e4a_VICTUS-15-FA0031DX-1.jpg'),
      img('https://cdn.prod.website-files.com/62141f21700a64ab3f816206/64ad7ac27cd445765564b11b_Dell%201505.jpg'),
      img('https://cdn.prod.website-files.com/62141f21700a64ab3f816206/64ad79b64b6011e52725b3a7_hyndai_hybook.png'),
    ],
    colors: [
  ...
  },
  {
    ...
    displayName: 'Laptop HP 14" - Ryzen 5 7535U',
    brand: 'ASUS',
  ...
  },
  {
    ...
    displayName: 'Laptop Dell 15" - Core i5 1235U',
    brand: 'Dell',
  ...
  },
  {
    ...
    displayName: 'Laptop Hyundai 14" - Celeron N4020',
    brand: 'Hyundai',
...
export const mockTabletDetail: ProductDetail = {
  ...
  originalQuota: 79,
  images: [
    { id: '1', url: '/images/tablets/equipo-696025d65fda1-1767908822.png', alt: 'Samsung Galaxy Tab S9 frontal', type: 'main' },
    { id: '2', url: '/images/tablets/equipo-6894be1650c5f-1754578454.png', alt: 'Samsung Galaxy Tab S9 lateral', type: 'gallery' },
    { id: '3', url: '/images/tablets/equipo-690a057859e07-1762264440.png', alt: 'Samsung Galaxy Tab S9 con S Pen', type: 'gallery' },
    { id: '4', url: '/images/tablets/equipo-65e296f838a4fa8ca14b6aec.png', alt: 'Samsung Galaxy Tab S9 posterior', type: 'gallery' },
    { id: '5', url: '/images/tablets/equipo-6834dcf1032d5-1748294897.webp', alt: 'Samsung Galaxy Tab S9 accesorios', type: 'detail' },
  ],
  colors: [
...
export const mockSimilarTablets: SimilarProduct[] = [
  {
    ...
    displayName: 'Tablet Apple 10.9" - A14 Bionic',
    brand: 'Apple',
    thumbnail: '/images/tablets/equipo-6894be1650c5f-1754578454.png',
    images: [
      img('/images/tablets/equipo-6894be1650c5f-1754578454.png'),
      img('/images/tablets/equipo-696025d65fda1-1767908822.png'),
      img('/images/tablets/equipo-690a057859e07-1762264440.png'),
    ],
    colors: [
  ...
  },
  {
    id: 'xiaomi-pad6',
    name: 'Xiaomi Pad 6',
    displayName: 'Tablet Xiaomi 11" - Snapdragon 870',
    brand: 'Xiaomi',
    thumbnail: '/images/tablets/equipo-690a057859e07-1762264440.png',
    images: [
      img('/images/tablets/equipo-690a057859e07-1762264440.png'),
      img('/images/tablets/equipo-65e296f838a4fa8ca14b6aec.png'),
      img('/images/tablets/equipo-696025d65fda1-1767908822.png'),
    ],
    colors: [
  ...
  },
  {
    ...
    displayName: 'Tablet Lenovo 12.6" - Snapdragon 870',
    brand: 'Lenovo',
    thumbnail: '/images/tablets/equipo-65e296f838a4fa8ca14b6aec.png',
    images: [
      img('/images/tablets/equipo-65e296f838a4fa8ca14b6aec.png'),
      img('/images/tablets/equipo-6894be1650c5f-1754578454.png'),
      img('/images/tablets/equipo-690a057859e07-1762264440.png'),
...
export const mockCelularDetail: ProductDetail = {
  ...
  originalQuota: 64,
  images: [
    { id: '1', url: '/images/celulares/equipo-6941e1dc19ba1-1765925340.png', alt: 'Samsung Galaxy A54 frontal', type: 'main' },
    { id: '2', url: '/images/celulares/equipo-6941d4d3d080a-1765922003.webp', alt: 'Samsung Galaxy A54 lateral', type: 'gallery' },
    { id: '3', url: '/images/celulares/equipo-6941db08b786d-1765923592.webp', alt: 'Samsung Galaxy A54 cámaras', type: 'gallery' },
    { id: '4', url: '/images/celulares/equipo-6941d7d610b3e-1765922774.webp', alt: 'Samsung Galaxy A54 posterior', type: 'gallery' },
    { id: '5', url: '/images/celulares/equipo-6941e149858a8-1765925193.webp', alt: 'Samsung Galaxy A54 en mano', type: 'detail' },
  ],
  colors: [
...
export const mockSimilarCelulares: SimilarProduct[] = [
  {
    ...
    displayName: 'Celular Xiaomi 6.67" - Snapdragon 7s Gen 2',
    brand: 'Xiaomi',
    thumbnail: '/images/celulares/equipo-69406c18a6ce4-1765829656.jpg',
    images: [
      img('/images/celulares/equipo-69406c18a6ce4-1765829656.jpg'),
      img('/images/celulares/equipo-6941c1e02b936-1765917152.jpg'),
      img('/images/celulares/equipo-6941c366b177e-1765917542.jpg'),
    ],
    colors: [
  ...
  },
  {
    ...
    displayName: 'Celular Motorola 6.55" - Dimensity 8020',
    brand: 'Motorola',
    thumbnail: '/images/celulares/equipo-6941d2c0b20f5-1765921472.webp',
    images: [
      img('/images/celulares/equipo-6941d2c0b20f5-1765921472.webp'),
      img('/images/celulares/equipo-6941d5dd5b6e6-1765922269.webp'),
      img('/images/celulares/equipo-6941ded9b6ee2-1765924569.webp'),
    ],
    colors: [
  ...
  },
  {
    ...
    displayName: 'Celular Samsung 6.4" - Snapdragon 8 Gen 1',
    brand: 'Samsung',
    thumbnail: '/images/celulares/equipo-693c5cac94532-1765563564.jpg',
    images: [
      img('/images/celulares/equipo-693c5cac94532-1765563564.jpg'),
      img('/images/celulares/equipo-693c734d0e4b2-1765569357.webp'),
      img('/images/celulares/equipo-693c867c17eeb-1765574268.webp'),
    ],
    colors: [
  ...
  },
  {
    ...
    displayName: 'Celular Realme 6.7" - Snapdragon 7s Gen 2',
    brand: 'Realme',
    thumbnail: '/images/celulares/equipo-69288a0ab5af2-1764264458.webp',
    images: [
      img('/images/celulares/equipo-69288a0ab5af2-1764264458.webp'),
      img('/images/celulares/equipo-674f8732a3a3e-1733265202.webp'),
      img('/images/celulares/equipo-6941ddc1eefdd-1765924289.jpg'),
    ],
    colors: [
