  ...
  <div className="col-span-full py-8">
    <div className="flex items-center gap-4">
      ...
      >
        ...
        <span className="text-[var(--text-faint,#9ca3af)] group-hover:text-[var(--color-primary)]">
          ({remainingProducts})
        </span>
  ...
  return (
    <div className="col-span-full py-8">
      <div className="max-w-md mx-auto">
        {/* Progress info */}
        <div className="flex justify-between items-center mb-2 text-xs text-[var(--text-muted,#6b7280)]">
          <span>
        ...
        {/* Progress bar */}
        <div className="relative h-2 bg-[var(--surface-2,#f3f4f6)] rounded-full overflow-hidden mb-4">
          <motion.div
        ...
        <Button
          variant="flat"
          className="w-full bg-[var(--surface-2,#f3f4f6)] hover:bg-[var(--surface-2,#e5e7eb)] text-[var(--text,#374151)] cursor-pointer transition-colors"
          onPress={onLoadMore}
    ...
    >
      ...
      >
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div className="flex items-center justify-center w-6 h-6 rounded-full bg-[var(--surface,#fff)]/20">
      ...
      {/* Remaining count */}
      <p className="mt-3 text-sm text-[var(--text-faint,#9ca3af)]">
