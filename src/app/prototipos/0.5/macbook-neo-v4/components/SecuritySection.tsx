...
import { securityFeatures } from '../data/v4Data';
import { ASSETS } from '../lib/constants';
import { RevealOnScroll } from '../../macbook-neo-v3/shared/components/RevealOnScroll';

export default function SecuritySection() {
  return (
    <section id="security" className="bg-white text-[#1d1d1f]">
      {/* Header */}
      <div className="max-w-[980px] mx-auto px-6 pt-24 text-center">
        <RevealOnScroll>
          <p className="text-[#86868b] text-sm font-semibold mb-2">Privacy and Security</p>
          ...
          <p className="text-[17px] md:text-[21px] text-[#6e6e73] max-w-[680px] mx-auto leading-[1.47]">
            MacBook Neo is built from the ground up with advanced security protections that come standard on every Mac. Automatic data encryption, free antivirus protections, and regular software updates give you peace of mind.
          </p>
        </RevealOnScroll>
      </div>
      ...
      <div className="max-w-[980px] mx-auto px-6 mt-16 md:mt-20">
        <div className="relative w-full aspect-[16/9] rounded-[18px] overflow-hidden">
          <Image
            src={ASSETS.performance[1]}
            alt="MacBook Neo security"
            fill
