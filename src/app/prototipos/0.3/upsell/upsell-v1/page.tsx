...
/**
 * Upsell V1 Page - BaldeCash v0.3
 *
 * Version 1: Cards uniformes + Cards lado a lado
 */
...
export default function UpsellV1Page() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      <header className="sticky top-0 z-50 bg-white border-b border-neutral-200">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-semibold text-neutral-800">Upsell V1</h1>
              <p className="text-xs text-neutral-500">Cards uniformes + Cards lado a lado</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            <PriceBreakdown items={breakdownItems} totalPrice={totalPrice} totalMonthlyQuota={totalQuota} displayMode={configV1.breakdownDisplay} />
      ...
      <SkipInsuranceModal isOpen={showSkipModal} onClose={() => setShowSkipModal(false)} onConfirmSkip={() => { setSelectedInsurance(null); setShowSkipModal(false); }} onSelectPlan={handleSelectInsurance} recommendedPlan={mockInsurancePlans.find(p => p.isRecommended)} config={configV1} />
    </div>
  );
}
