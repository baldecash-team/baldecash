      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {displayProducts.map((product, index) => (
          ...
          >
            <Card
              isPressable
              className="border border-neutral-200 hover:border-[#4654CD]/50 transition-all cursor-pointer"
              onPress={() => onProductClick?.(product.id)}
            >
              <CardBody className="p-3">
                <div className="flex gap-3">
                  {/* Image */}
                  <div className="w-20 h-20 flex-shrink-0 bg-neutral-50 rounded-lg p-2">
                    <img
