...
/**
 * PricingCalculatorV1 - Calculadora con botones de plazo
 *
 * Caracteristicas:
 * - Botones de plazo (12-48 meses)
...
import { Calculator, CreditCard, Percent, ChevronRight, Check } from 'lucide-react';
...
export const PricingCalculatorV1: React.FC<PricingCalculatorProps> = ({
  basePrice,
  discount = 0,
  monthlyRate = 0.012,
}) => {
  ...
  return (
    <div className="bg-white border border-neutral-200 rounded-xl p-6 space-y-6">
      ...
      <div className="bg-[#4654CD]/5 border border-[#4654CD]/20 rounded-xl p-6 text-center">
        ...
        <p className="text-4xl font-black text-[#4654CD] font-['Baloo_2']">
...
export default PricingCalculatorV1;
