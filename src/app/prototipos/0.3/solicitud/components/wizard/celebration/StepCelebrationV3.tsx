...
/**
 * StepCelebrationV3 - Celebración con confetti sutil
 *
 * C.18 V3: Mini confetti/estrellas animadas
 * C.19 V3: Mensaje + animación celebratoria
 * C.20 V3: Animación larga (1s)
 */
...
export const StepCelebrationV3: React.FC<StepCelebrationProps> = ({
  stepName,
  stepNumber,
  onComplete,
}) => {
...
export default StepCelebrationV3;
