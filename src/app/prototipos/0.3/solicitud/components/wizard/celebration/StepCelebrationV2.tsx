...
/**
 * StepCelebrationV2 - Celebración con mensaje
 *
 * C.18 V2: Mensaje de felicitación + icono
 * C.19 V2: Mensaje personalizado por paso
 * C.20 V2: Animación media (500ms)
 */

const stepMessages: Record<number, string> = {
  1: '¡Genial! Ya te conocemos mejor.',
  2: '¡Excelente! Tu perfil académico está listo.',
  3: '¡Perfecto! Solo queda confirmar.',
  4: '¡Listo! Tu solicitud está completa.',
};

export const StepCelebrationV2: React.FC<StepCelebrationProps> = ({
  stepName,
  stepNumber,
  onComplete,
}) => {
...
export default StepCelebrationV2;
