 ...
 * Modal with TEA, TCEA, commissions, TyC details.
 * PDF download button.
 */

import React, { useState } from 'react';
import { Calendar, ChevronDown, ChevronUp, Check, Info, Download, X, FileText, Percent, AlertCircle, Scale } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-2 text-xs text-neutral-500 mt-4">
                ...
                <p>
                  ...
                  Consulta nuestros <a href="/prototipos/0.4/legal/terminos" className="text-[#4654CD] underline">Terminos y Condiciones</a> y
                  <a href="/prototipos/0.4/legal/privacidad" className="text-[#4654CD] underline ml-1">Politica de Privacidad</a>.
                </p>
              </div>
            </div>
          </ModalBody>
