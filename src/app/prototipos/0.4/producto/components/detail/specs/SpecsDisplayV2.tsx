...
/**
 * SpecsDisplayV2 - Cards grid por categoría
 * Version: V2 - Grid of cards, one per category
 */
...
export const SpecsDisplayV2: React.FC<SpecsProps> = ({ specs }) => {
  return (
