...
/**
 * PortsDisplayV1 - Visual Laptop Ports Layout
 *
 * Shows ports organized by position (left/right) with
 * a visual representation of the laptop.
 */
...
import { ProductPort } from '../../../types/detail';
...
export const PortsDisplayV1: React.FC<PortsDisplayProps> = ({ ports }) => {
