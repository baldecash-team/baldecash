...
/**
 * ProductLimitationsV6 - Descriptive Limitations Display
 *
 * Simple descriptive layout without progress bar or checkboxes.
 * Clean, informative design focusing on content.
 */
      ...
      <div className="bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-gray-200 rounded-2xl p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 ml-14">
            Informacion que debes tener en cuenta antes de decidir
          </p>
        </div>
