...
/**
 * EmailCaptureV1 - Campo Prominente
 * "Avísame cuando pueda aplicar" con campo de email destacado
 */
export const EmailCaptureV1: React.FC<EmailCaptureV1Props> = ({ onSubmit }) => {
  ...
  return (
    <div className="bg-[#4654CD]/5 rounded-xl p-6 border border-[#4654CD]/20">
