...
/**
 * Solicitud Recibida Preview Page
 * Same as Aprobado but with text indicating the request will be evaluated in 24h
 */
...
export default function RecibidoPreviewPage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Received Screen - Same as ApprovalScreen but with different text */}
      <ReceivedScreen
      ...
      <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-2">
        <TokenCounter sectionId="PROMPT_15_RECEIVED" version="0.4" />
        <Button
          isIconOnly
          radius="md"
