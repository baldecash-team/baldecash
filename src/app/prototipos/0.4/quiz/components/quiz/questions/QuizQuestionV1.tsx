 ...
 *
 * PREFERIDO (B.100 - basado en 0.3 V3): Diseno moderno con opciones
 * como chips/pills y animaciones suaves. Ideal para preferencias.
 */
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="text-center">
        <motion.div
          ...
          className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-[#4654CD]/10 rounded-2xl mb-4"
        >
          <Sparkles className="w-7 h-7 sm:w-8 sm:h-8 text-[#4654CD]" />
        </motion.div>
