...
/**
 * SocialProofV1 - Convenios + Testimonios Combinado
 *
 * Concepto: Sección superior con logos en marquee + Carrusel de testimonios abajo
 * Estilo: Fondo neutro, logos grayscale con hover, testimonios con cards
 */
