...
/**
 * ConvenioCtaV6 - CTA con WhatsApp directo
 * Version: V6 - Call to action con botón de WhatsApp prominente
 */
...
export const ConvenioCtaV6: React.FC<ConvenioCtaProps> = ({
  convenio,
  cuotaDesde = 49,
  onVerEquipos,
}) => {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hola, soy estudiante de ${convenio.nombre} y me interesa financiar un equipo con el convenio. ¿Me pueden ayudar?`
  );
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-lg text-white/80 mb-6">
              ...
              y explicarte todos los beneficios de tu convenio {convenio.nombreCorto}.
            </p>
