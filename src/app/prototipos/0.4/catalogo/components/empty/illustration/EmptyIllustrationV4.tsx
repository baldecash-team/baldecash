  ...
  return (
    <div className={`flex flex-col items-center text-center ${className}`}>
      ...
      <div className="relative w-48 h-40 mb-6">
        ...
        <motion.div
          className="absolute top-4 left-8 w-16 h-16 bg-[#4654CD]/10 rounded-full"
          animate={{
            y: [0, -8, 0],
            scale: [1, 1.05, 1],
          }}
        ...
        {/* Shape cuadrado */}
        <motion.div
          className="absolute top-8 right-8 w-12 h-12 bg-[#03DBD0]/20 rounded-lg"
          animate={{
            y: [0, 8, 0],
            rotate: [0, 5, 0],
          }}
        ...
        <motion.div
          className="absolute bottom-4 left-1/2 -translate-x-1/2 w-20 h-20 bg-[#4654CD]/15"
          style={{
        ...
        {/* Líneas decorativas */}
        <motion.div
          className="absolute top-1/2 left-4 w-8 h-0.5 bg-[#4654CD]/30 rounded-full"
          animate={{ scaleX: [1, 0.5, 1] }}
          transition={{ duration: 2, repeat: Infinity }}
        />
        <motion.div
          className="absolute top-1/3 right-4 w-6 h-0.5 bg-[#03DBD0]/40 rounded-full"
        ...
        {/* Puntos flotantes */}
        <motion.div
          className="absolute top-2 left-1/2 w-2 h-2 bg-[#4654CD] rounded-full"
          animate={{ opacity: [0.3, 1, 0.3] }}
          transition={{ duration: 1.5, repeat: Infinity }}
        />
        <motion.div
          className="absolute bottom-8 right-12 w-3 h-3 bg-[#03DBD0] rounded-full"
