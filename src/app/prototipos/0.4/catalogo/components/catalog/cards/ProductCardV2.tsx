...
import { ShoppingCart, Heart, GraduationCap, Gamepad2, Palette, Briefcase, Code, Zap, BatteryFull, Feather, Eye } from 'lucide-react';
        ...
        <CardBody className="p-0">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute top-3 right-3 p-2 rounded-full bg-white/90 hover:bg-[#4654CD]/10 shadow-md cursor-pointer transition-all z-10"
            >
