    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: 'ing-software', label: 'Ingeniería de Software' },
          { value: 'ing-industrial', label: 'Ingeniería Industrial' },
          { value: 'ing-civil', label: 'Ingeniería Civil' },
          { value: 'ing-mecanica', label: 'Ingeniería Mecánica' },
          { value: 'ing-electronica', label: 'Ingeniería Electrónica' },
          { value: 'ing-mecatronica', label: 'Ingeniería Mecatrónica' },
          { value: 'ing-ambiental', label: 'Ingeniería Ambiental' },
          { value: 'arquitectura', label: 'Arquitectura' },
          { value: 'administracion', label: 'Administración de Empresas' },
          { value: 'contabilidad', label: 'Contabilidad' },
          { value: 'economia', label: 'Economía' },
          { value: 'marketing', label: 'Marketing' },
          { value: 'negocios-int', label: 'Negocios Internacionales' },
