...
export const VERSION_REGISTRY: VersionConfig[] = [
  ...
  },
  {
    ...
    status: 'in_progress',
    sections: [
      { id: 'hero', name: 'Hero', path: '/prototipos/0.4/hero', status: 'pending', promptNumber: '01' },
      ...
      { id: 'solicitud', name: 'Solicitud', path: '/prototipos/0.4/solicitud', status: 'pending', promptNumber: '08' },
